 ...
 */
inline void SWAP(short *a, int j, int k)
{
    short temp = a[j];  a[j] = a[k];  a[k] = temp;
}

int default_comparator(short a, short b)
{
...
{
    return short_linearsearch_with(default_comparator,a,k,N);
}

int short_binarysearch(short a[], short k, int N)
{
    return short_binarysearch_with(default_comparator,a,k,N);
}

int short_linearsearchX(short a[], short k, int N)
{
    return short_linearsearchX_with(default_comparator,a,k,N);
}

void short_bubblesort(short a[], int N) { short_bubblesort_with(default_comparator,a,N); }
void short_selectsort(short a[], int N) { short_selectsort_with(default_comparator,a,N); }
void short_insertsort(short a[], int N) { short_insertsort_with(default_comparator,a,N); }
void short_heapsort(  short a[], int N) { short_heapsort_with(  default_comparator,a,N); }
void short_quicksort( short a[], int N) { short_quicksort_with( default_comparator,a,N); }
 ...
 */
int smallest(comparator compare, short a[], int lo, int N)
{
    int s = lo, i;
    for (i=lo+1; i<N; i++)
 ...
 */
void insert(comparator compare, short a[], short x, int p)
{
    int i = 0, j;
 ...
 */
void siftDown(comparator compare, short a[], int k, int N)
{
    int parent=k;
    int child;
    while(1) {
...
void makeHeap(comparator compare, short a[], int N)
{
    int k = (N-1) / 2;
    while (k>=0) {
...
* Quick sort                                                                              *
******************************************************************************************/
void q_sort(comparator compare, short *a, int left, int right, int N)
{
    int i, last, pivot;
    if (left >= right)
        return;
