 ...
 */
inline void SWAP(double *a, int j, int k)
{
    double temp = a[j];  a[j] = a[k];  a[k] = temp;
}

int default_comparator(double a, double b)
{
...
{
    return double_linearsearch_with(default_comparator,a,k,N);
}

int double_binarysearch(double a[], double k, int N)
{
    return double_binarysearch_with(default_comparator,a,k,N);
}

int double_linearsearchX(double a[], double k, int N)
{
    return double_linearsearchX_with(default_comparator,a,k,N);
}

void double_bubblesort(double a[], int N) { double_bubblesort_with(default_comparator,a,N); }
void double_selectsort(double a[], int N) { double_selectsort_with(default_comparator,a,N); }
void double_insertsort(double a[], int N) { double_insertsort_with(default_comparator,a,N); }
void double_heapsort(  double a[], int N) { double_heapsort_with(  default_comparator,a,N); }
void double_quicksort( double a[], int N) { double_quicksort_with( default_comparator,a,N); }
 ...
 */
int smallest(comparator compare, double a[], int lo, int N)
{
    int s = lo, i;
    for (i=lo+1; i<N; i++)
 ...
 */
void insert(comparator compare, double a[], double x, int p)
{
    int i = 0, j;
 ...
 */
void siftDown(comparator compare, double a[], int k, int N)
{
    int parent=k;
    int child;
    while(1) {
...
void makeHeap(comparator compare, double a[], int N)
{
    int k = (N-1) / 2;
    while (k>=0) {
...
* Quick sort                                                                              *
******************************************************************************************/
void q_sort(comparator compare, double *a, int left, int right, int N)
{
    int i, last, pivot;
    if (left >= right)
        return;
