 ...
 */
inline void SWAP(char *a, int j, int k)
{
    char temp = a[j];  a[j] = a[k];  a[k] = temp;
}

int default_comparator(char a, char b)
{
...
{
    return char_linearsearch_with(default_comparator,a,k,N);
}

int char_binarysearch(char a[], char k, int N)
{
    return char_binarysearch_with(default_comparator,a,k,N);
}

int char_linearsearchX(char a[], char k, int N)
{
    return char_linearsearchX_with(default_comparator,a,k,N);
}

void char_bubblesort(char a[], int N) { char_bubblesort_with(default_comparator,a,N); }
void char_selectsort(char a[], int N) { char_selectsort_with(default_comparator,a,N); }
void char_insertsort(char a[], int N) { char_insertsort_with(default_comparator,a,N); }
void char_heapsort(  char a[], int N) { char_heapsort_with(  default_comparator,a,N); }
void char_quicksort( char a[], int N) { char_quicksort_with( default_comparator,a,N); }
 ...
 */
int smallest(comparator compare, char a[], int lo, int N)
{
    int s = lo, i;
    for (i=lo+1; i<N; i++)
 ...
 */
void insert(comparator compare, char a[], char x, int p)
{
    int i = 0, j;
 ...
 */
void siftDown(comparator compare, char a[], int k, int N)
{
    int parent=k;
    int child;
    while(1) {
...
void makeHeap(comparator compare, char a[], int N)
{
    int k = (N-1) / 2;
    while (k>=0) {
...
* Quick sort                                                                              *
******************************************************************************************/
void q_sort(comparator compare, char *a, int left, int right, int N)
{
    int i, last, pivot;
    if (left >= right)
        return;
